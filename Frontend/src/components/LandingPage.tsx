...
import { 
  Play, Trophy, Star, Target, Users, Gamepad2, 
  CheckCircle, Rocket, ChevronRight, Wallet, FileSignature, 
  Palette, Award
} from 'lucide-react';
        ...
        <div className="text-center mb-16 sm:mb-24">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-12 sm:mb-16 px-4 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
            ...
            >
              ...
              {isConnecting ? "Connecting..." : (isConnected ? "Enter Playground" : "Connect & Explore")}
